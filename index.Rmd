...
There are several supplementary texts that are not required, but may be of benefit to those who want to pursue extra study and/or have physical materials readily available to them to consult: 

* Grolemund and Wickham's **[R For Data Science](https://www.amazon.com/R-Data-Science-Hadley-Wickham/dp/1491910399/ref=as_li_ss_tl?ie=UTF8&qid=1469550189&sr=8-1&keywords=R+for+data+science&linkCode=sl1&tag=devtools-20&linkId=6fe0069f9605cf847ed96c191f4e84dd)** is a fantastic text that will go much deeper on certain topics than we'll cover in this course. You can purchase a copy for yourself from Amazon or other booksellers - it's generally around $25. Also note that the authors offer an [online version of this book](https://r4ds.had.co.nz/) for free use.
* Peng and Matsui's **[The Art of Data Science](https://www.amazon.com/Art-Data-Science-Roger-Peng/dp/1365061469/ref=sr_1_1?dchild=1&keywords=the+art+of+data+science&qid=1623077320&sr=8-1)**. This is much more of a holistic, conceptual text on what it means to "do" data science and could be useful contextual reading for certain approaches taken within this text. You can purchase a copy for yourself from Amazon or other booksellers - it's generally around $20. Note again that the authors offer an [online version of this book](https://bookdown.org/rdpeng/artofdatascience/epicycles-of-analysis.html) for free use (see a trend here?).
